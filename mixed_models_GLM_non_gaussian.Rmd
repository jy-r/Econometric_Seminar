...
Source Zuur et al. (2009) et al. (page 326)

Relationship between the presence and absence of larvae in deer and the explanatory variables `length` and  `sex` of the deer and the `Farm`.
